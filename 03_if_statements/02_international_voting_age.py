...
def main():
    ...
    if age >= peturksbouipo:
        print(f"Ypu can vote in Peturksbouipo where the voting age is {peturksbouipo}.")
    else:
        print(f"you cannot vote in Peturksbouipo where the voting age is {peturksbouipo}.")
    
    
    if age >= stanlau:
        print(f"You can in Stanlau where the voting age is {stanlau}.")
    else:
        print(f"you cannot in Stanlau where the voting age is {stanlau}.")
